...
| **HBI-PO-DEC-GAP01-001** | **GAP-01 Minimal MVP Correction — Case Decision State vs Product Evaluation State** | **DECISION RESOLVED — IMPLEMENTATION PENDING** | **2026-09-12** |
...
| **HBI-PO-DEC-CORE-001** | **HBI Core Definition v1 — Problem-Centered, Evidence-Bound Decision Support** | **DECIDED / ACCEPTED** | **2026-09-13** |
...
| **HBI-PO-DEC-GAP03-001** | **GAP-03 Out-of-Stock Candidate Elimination Policy — eliminate before Reasoning** | **DECISION RESOLVED — IMPLEMENTATION PENDING** | **2026-09-13** |
| **HBI-PO-DEC-GAP04-002** | **GAP-04 Option B — one current Recommendation per Case+Product; re-Generate updates** | **DECISION RESOLVED — IMPLEMENTATION NOT AUTHORIZED** | **2026-09-13** |
