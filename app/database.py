...
def init_db():
    from app.models import product, product_knowledge, evidence, evidence_mutation_log, customer, case, recommendation, inventory, sale, sale_item, category, stock_movement, payment, sale_return, operational_fx_rate, product_mutation_log, user_role, profile_fact, admin_credential, feedback, follow_up, outcome_assessment
