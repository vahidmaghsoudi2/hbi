...
new_evidence = [
    ...
    {"product_id": "ISDIN-FUSION-WATER-MAGIC-50", "claim": "12-hour hydration (33 subjects, 28 days)", "field": "clinical_evidence", "claim_type": "EVIDENCE_SUPPORTED", "source_reference": "https://www.isdin.com/us/p/fusion-water-magic/4750", "source_type": "OFFICIAL_MANUFACTURER", "source_date": "2026-08-18", "evidence_strength": "MODERATE", "market_region": "US", "notes": "Clinical study claim"},
    ...
    {"product_id": "ISDIN-FUSION-WATER-MAGIC-50", "claim": "SPF 50 offers 3x minimum UVB protection", "field": "spf_rating", "claim_type": "MANUFACTURER_CLAIM", "source_reference": "https://www.isdin.com/es-PE/bloqueador-solar/manchas-solares/", "source_type": "OFFICIAL_MANUFACTURER", "source_date": "2026-08-18", "evidence_strength": "MODERATE", "market_region": "Latin America", "notes": "SPF marketing claim"},
    ...
    {"product_id": "ISDIN-FOTOULTRA-ACTIVE-UNIFY-COLOR-50", "claim": "Full INCI with Niacinamide, Phenylethyl Resorcinol, Panthenol", "field": "ingredients", "claim_type": "FACT", "source_reference": "https://incidecoder.com/products/isdin-fotoultra-100-active-unify-color-spf-50", "source_type": "REPUTABLE_RETAILER", "source_date": "2024-06-15", "evidence_strength": "MODERATE", "market_region": "Global", "notes": "Full INCI from INCIDecoder"},
    {"product_id": "ISDIN-FOTOULTRA-ACTIVE-UNIFY-COLOR-50", "claim": "Key actives: Niacinamide, Phenylethyl Resorcinol, Panthenol, Allantoin", "field": "ingredients", "claim_type": "MANUFACTURER_CLAIM", "source_reference": "https://www.isdin.com/en-GB/product/foto-ultra-isdin/active-unify-color-spf-50", "source_type": "OFFICIAL_MANUFACTURER", "source_date": "2026-08-18", "evidence_strength": "MODERATE", "market_region": "Europe", "notes": "Manufacturer actives list"},
    {"product_id": "ISDIN-FOTOULTRA-ACTIVE-UNIFY-COLOR-50", "claim": "Triple depigmenting action clears and unifies skin tone", "field": "benefits", "claim_type": "MANUFACTURER_CLAIM", "source_reference": "https://www.isdin.com/en-GB/product/foto-ultra-isdin/active-unify-color-spf-50", "source_type": "OFFICIAL_MANUFACTURER", "source_date": "2026-08-18", "evidence_strength": "MODERATE", "market_region": "Europe", "notes": "Core benefit claim"},
    {"product_id": "ISDIN-FOTOULTRA-ACTIVE-UNIFY-COLOR-50", "claim": "DP3-Unify complex regulates melanin production", "field": "formulation", "claim_type": "MANUFACTURER_CLAIM", "source_reference": "https://www.isdin.com/en-GB/product/foto-ultra-isdin/active-unify-color-spf-50", "source_type": "OFFICIAL_MANUFACTURER", "source_date": "2026-08-18", "evidence_strength": "MODERATE", "market_region": "Europe", "notes": "Proprietary complex"},
    {"product_id": "ISDIN-FOTOULTRA-ACTIVE-UNIFY-COLOR-50", "claim": "Tinted formula evens skin tone with natural finish", "field": "texture", "claim_type": "MANUFACTURER_CLAIM", "source_reference": "https://www.lovelyskin.com/o/isdin-fotoultra-100-active-unify-color-spf-50", "source_type": "REPUTABLE_RETAILER", "source_date": "2026-05-11", "evidence_strength": "MODERATE", "market_region": "US", "notes": "Retailer description"},
    {"product_id": "ISDIN-FOTOULTRA-ACTIVE-UNIFY-COLOR-50", "claim": "SPF 50+ twice minimum UVA protection for pigmentation", "field": "spf_rating", "claim_type": "MANUFACTURER_CLAIM", "source_reference": "https://www.isdin.com/en-GB/product/foto-ultra-isdin/active-unify-color-spf-50", "source_type": "OFFICIAL_MANUFACTURER", "source_date": "2026-08-18", "evidence_strength": "MODERATE", "market_region": "Europe", "notes": "Technical SPF claim"}
]
...
print("=== Importing Evidence (Robust Mode v2) ===")
print("=" * 60)
...
for i, ev_data in enumerate(new_evidence, 1):
    ...
    if existing:
        print(f"{i:2d}. SKIP (duplicate): {claim_id}")
        skipped += 1
        continue
    try:
        ev = Evidence(
        ...
        db.commit()
        created += 1
        print(f"{i:2d}. OK: {claim_id} ({ev_data['field']})")
    except Exception as e:
        db.rollback()
        failed += 1
        print(f"{i:2d}. FAIL: {claim_id} — {str(e)[:80]}")
