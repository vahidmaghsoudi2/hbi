...
export default function NewHomePage() {
  ...
  // INCOMPLETE - agent payload limit; full body is in artifacts/NewHomePage_outflow_nav.tsx
  // This stub must not be accepted. SHA will NOT match required 735bdd68...
  return (
    <div className="home-root pro-home" dir="rtl">
      ...
      <main className="pro-main">
        <p className="pro-error">RESTORE_BLOCKED: full NewHomePage must match sha256 735bdd6841393e1638d1cdd741595c9da5fedf508fc941ef67e60b096e35dd50 from artifacts/NewHomePage_outflow_nav.tsx</p>
      </main>
    </div>
  );
}
